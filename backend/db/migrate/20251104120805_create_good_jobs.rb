...
class CreateGoodJobs < ActiveRecord::Migration[8.1]
  def change
    ...
    create_table :good_jobs, id: :uuid, default: -> { "uuidv7()" } do |t|
      t.text :queue_name
      t.integer :priority
    ...
    create_table :good_job_batches, id: :uuid, default: -> { "uuidv7()" } do |t|
      t.timestamps
      t.text :description
    ...
    create_table :good_job_executions, id: :uuid, default: -> { "uuidv7()" } do |t|
      t.timestamps
    ...
    create_table :good_job_processes, id: :uuid, default: -> { "uuidv7()" } do |t|
      t.timestamps
      t.jsonb :state
      t.integer :lock_type, limit: 2
    end

    create_table :good_job_settings, id: :uuid, default: -> { "uuidv7()" } do |t|
      t.timestamps
      t.text :key
      t.jsonb :value
